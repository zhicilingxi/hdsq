...
/* background: url(/Public/images/Home/input.jpg) no-repeat; */
...
input.LpNamem{
  background: url(/Public/images/Home/mjBg.png) no-repeat 95% center;
}
</style>
...
<form action="<?php echo C('scurl')['HD_INDEX'];?>bm/" method="post" name="form999999" id="form999999" >
  ...
  <tr>
    ...
    <img src="/Public/images/Home/ljbmCj.jpg" border="0"></a></div></td>
    </tr>
</tbody></table>
    </form>
...
function bmok(){
	...
	diag.Height = 180;
	diag.Title = "我要报名";
	diag.URL = "<?php echo C('scurl')['HD_INDEX'];?>bmok?is1=1";
	diag.show();
	$("#_DialogDiv_0").show();
}
function bmsb(msg){
	...
	diag.Height = 180;
	diag.Title = "我要报名";
	diag.URL = "<?php echo C('scurl')['HD_INDEX'];?>bmsb?msg="+msg+'&is1=1';
	diag.show();
	$("#_DialogDiv_0").show();
}
</script>
