...
<div class="wrap">
    ...
    <section class="section">
        ...
        <form id="js-install-form" action="/index/step4/" method="post">
            ...
            <div class="server">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="dbname" id="dbname" value="hdsq" class="input"></td>
                        <td>
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="sitename" value="hdsq活动模板系统" class="input"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="siteinfo" class="input" value="hdsq活动模板系统">
                        </td>
                        <td>
            ...
            <div class="bottom text-center">
                <a href="/index/step2/" class="btn btn-primary">上一步</a>
    ...
    <script>
        ...
        $(function () {
            ...
            var focus_tips = {
                ...
                dbpw: '',
                dbname: '',
                dbprefix: '建议使用默认，同一数据库安装多个hzcms时需修改',
