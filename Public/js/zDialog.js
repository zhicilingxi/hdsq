 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = 'http://www.sc.cc/Public/images/home/';
...
Dialog.prototype.create = function () {
    ...
    var html = '\
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4; border:#cc9966 8px solid;background-color:#fff;  ">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="20" ><div style="width: 20px;"></div></td>\
      <td  ><div style="padding: 9px 0 0 4px; border-bottom:1px solid #dcdcdc;float: left; font-weight: bold;text-align:left; font-size:16px;color:#fa4c06;width:100%;line-height:33px;position:relative"><span style="font-size:16px;font-family:Microsoft YaHei;" id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" onmouseout="this.style.backgroundImage=\'url(' + IMAGESPATH + 'dialog_closebtn_over.jpg)\'" onmouseover="this.style.backgroundImage=\'url(' + IMAGESPATH + 'dialog_closebtn_over.jpg)\'"  style="right:25px; top:20px; position:absolute; height: 22px; width: 22px;  z-index:999;cursor: pointer; background-image: url(' + IMAGESPATH + 'dialog_closebtn_over.jpg);' + (this.ShowCloseButton ? "" : "display:none;") + '"></div></td>\
      <td width="20"><div style="width: 20px;"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      <td width="20" ></td>\
