 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = 'http://test.sitrue.cc/Public/web/hdlunbotu/images/';
...
LDialog.prototype.displacePath = function () {
    if (this.URL.substr(0, 8) == "https://" || this.URL.substr(0, 7) == "http://" || this.URL.substr(0, 1) == "/" || this.URL.substr(0, 11) == "javascript:") {
        return this.URL;
    } else {
...
LDialog.prototype.create = function () {
    ...
    var LDialogDivWidth = this.Width + 13 + 13;
    ...
    var html = '\
  <table id="_LDialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;background-color:#000;  ">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="20" ><div style="width: 20px;"></div></td>\
      <td  ><div style="padding: 9px 0 0 4px; float: left; font-weight: bold;text-align:left; font-size:16px;color:#fa4c06;width:100%;line-height:33px;position:relative;"><span style="font-size:16px;" id="_Title_' + this.ID + '">' + '</span></div>\
