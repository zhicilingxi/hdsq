...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4; border:#cc9966 8px solid;background-color:#fff;  ">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      ...
      <td  ><div style="padding: 9px 0 0 4px; float: left; font-weight: bold;text-align:center; font-size:24px;color:#333333;width:100%;line-height:56px;position:relative;font-weight:normal;"><span style="font-size:24px;font-family:Microsoft YaHei;" id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" onmouseout="this.style.backgroundImage=\'url(' + IMAGESPATH + 'dialog_closebtn_over1.jpg)\'" onmouseover="this.style.backgroundImage=\'url(' + IMAGESPATH + 'dialog_closebtn_over1.jpg)\'"  style="right:25px; top:20px; position:absolute; height: 40px; width: 40px;  z-index:999;cursor: pointer; background-image: url(' + IMAGESPATH + 'dialog_closebtn_over1.jpg);' + (this.ShowCloseButton ? "" : "display:none;") + '"></div></td>\
